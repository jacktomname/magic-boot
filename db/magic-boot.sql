...
CREATE TABLE `sys_configure` (
 ...
 `configure_key` VARCHAR(255) NOT NULL COMMENT '键值' COLLATE 'utf8mb4_0900_ai_ci',
 ...
 `configure_type` VARCHAR(50) NOT NULL DEFAULT '0' COMMENT '配置类型' COLLATE 'utf8mb4_0900_ai_ci',
 `configure_desc_ribe` VARCHAR(50) NULL DEFAULT NULL COMMENT '配置说明' COLLATE 'utf8mb4_0900_ai_ci',
...
ENGINE=InnoDB
;
INSERT INTO `sys_configure` (`id`, `configure_value`, `configure_key`, `configure_name`, `configure_condition`, `configure_type`, `configure_desc_ribe`, `is_del`, `create_by`, `create_date`, `update_by`, `update_date`, `remarks`) VALUES ('150bad1208934eaa98ab5a980347eaa2', '10:30:00', 'breakfast.start.date', '早餐开始时间', NULL, '1', NULL, 0, '1', '2022-05-21 12:03:24', '1', '2022-05-21 13:55:16', NULL);
INSERT INTO `sys_configure` (`id`, `configure_value`, `configure_key`, `configure_name`, `configure_condition`, `configure_type`, `configure_desc_ribe`, `is_del`, `create_by`, `create_date`, `update_by`, `update_date`, `remarks`) VALUES ('2b68e98eb2a04f24b6e1eb5aa9c0900c', '3', 'three.hours', '三小时', 'region=461 and type = 1', '1', '使用场景：\n朝阳区条件并且是某类型才获取当前配置文件', 0, '1', '2022-05-21 12:14:05', '1', '2022-05-21 13:55:12', NULL);
...
INSERT INTO `sys_configure` (`id`, `configure_value`, `configure_key`, `configure_name`, `configure_condition`, `configure_type`, `configure_desc_ribe`, `is_del`, `create_by`, `create_date`, `update_by`, `update_date`, `remarks`) VALUES ('e0a007455bc04b1a9e03001c1d66bba3', '10:00:00', 'breakfast.end.date', '早餐结束时间', NULL, '1', NULL, 0, '1', '2022-05-21 12:36:22', '1', '2022-05-21 13:55:08', NULL);
